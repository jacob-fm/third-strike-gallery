...
export const characters: Character[] = [
  {
    ...
    moves: [
      ...
      { name: "Air Stampede", input: "↓ + HK (air)", category: "normal" },
      {
        ...
        input: "360° + P",
        category: "special",
        description: "A powerful command grab that slams the opponent",
      },
      {
        name: "Hyper Bomb",
        input: "↓↙← + P",
        category: "special",
        description: "A rushing grab attack",
      },
      {
        name: "Flash Chop",
        input: "↓↘→ + P",
        category: "special",
        description: "A chop strike that can be charged",
      },
      {
        name: "Air Knee Smash",
        input: "↓↘→ + K",
        category: "special",
        description: "A dive knee strike from the air",
      },
      {
        name: "Boomerang Raid",
        input: "↓↙← + K",
        category: "special",
        description: "A spinning kick attack",
      },
      {
        name: "Stun Gun Headbutt",
        input: "↓↓ + P",
        category: "special",
        description: "A headbutt using stored energy",
      },
      {
        name: "Hyper Bomb",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 1,
        description: "SA1: A series of powerful slams",
      },
      {
        name: "Boomerang Raid",
        input: "↓↘→↓↘→ + K",
        category: "super",
        superArt: 2,
        description: "SA2: Multiple spinning kick strikes",
      },
      {
        name: "Stun Gun Headbutt",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 3,
        description: "SA3: A powerful charged headbutt",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Solar Plexus Strike", input: "→ + MK", category: "normal" },
      {
        ...
        input: "↓↘→ + P",
        category: "special",
        description: "A fireball projectile",
      },
      {
        name: "Shoryuken",
        input: "→↓↘ + P",
        category: "special",
        description: "An uppercut with invincible startup",
      },
      {
        name: "Tatsumaki Senpukyaku",
        input: "↓↙← + K",
        category: "special",
        description: "A spinning hurricane kick",
      },
      {
        name: "Joudan Sokutou Geri",
        input: "→→ + MK",
        category: "special",
        description: "A powerful side kick",
      },
      {
        name: "Denjin Hadoken",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 1,
        description: "SA1: A chargeable electric fireball",
      },
      {
        name: "Shin Shoryuken",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 2,
        description: "SA2: A devastating rising uppercut",
      },
      {
        ...
        category: "super",
        superArt: 3,
        description: "SA3: A rapid series of kicks",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Inazuma Kick", input: "→ + MK", category: "normal" },
      {
        ...
        input: "↓↘→ + P",
        category: "special",
        description: "A fireball that can be delayed",
      },
      {
        name: "Shoryuken",
        input: "→↓↘ + P",
        category: "special",
        description: "A flaming uppercut",
      },
      {
        name: "Tatsumaki Senpukyaku",
        input: "↓↙← + K",
        category: "special",
        description: "A hurricane kick with more hits",
      },
      {
        name: "Zenpou Tenshin",
        input: "↙↓↘ + K",
        category: "special",
        description: "A roll behind the opponent",
      },
      {
        name: "Shoryu Cannon",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 1,
        description: "SA1: A powerful Shoryuken followed by more hits",
      },
      {
        name: "Shoryu Reppa",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 2,
        description: "SA2: A series of rapid Shoryukens",
      },
      {
        name: "Shippu Jinraikyaku",
        input: "↓↙←↓↙← + K",
        category: "super",
        superArt: 3,
        description: "SA3: A chain of powerful kicks",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "→ + MK (air)",
        category: "normal",
        description: "An axe kick from the air",
      },
      {
        name: "Hazanshu",
        input: "↓ + HK",
        category: "normal",
        description: "A flipping overhead kick",
      },
      {
        name: "Kikoken",
        input: "→↓↘ + P (charge ←→)",
        category: "special",
        description: "A slow chi ball projectile",
      },
      {
        name: "Hyakuretsukyaku",
        input: "K (rapidly)",
        category: "special",
        description: "Rapid-fire lightning kicks",
      },
      {
        name: "Tenshokyaku",
        input: "↓↑ + K",
        category: "special",
        description: "A spinning anti-air kick",
      },
      {
        name: "Spinning Bird Kick",
        input: "↓↑ + K (charge)",
        category: "special",
        description: "A spinning helicopter kick",
      },
      {
        name: "Hazan Shukyaku",
        input: "↓↘→↓↘→ + K",
        category: "super",
        superArt: 1,
        description: "SA1: A sequence of powerful overhead kicks",
      },
      {
        name: "Kikosho",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 2,
        description: "SA2: A concentrated ball of chi",
      },
      {
        name: "Houyoku-sen",
        input: "↓↘→↓↘→ + K",
        category: "super",
        superArt: 3,
        description: "SA3: A rapid series of lightning kicks",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "← + MP",
        category: "normal",
        description: "A counter punch",
      },
      {
        name: "Short Swing Blow",
        input: "↓ + MP",
        category: "normal",
        description: "An overhead hook",
      },
      {
        name: "Machine Gun Blow",
        input: "↓↘→ + P",
        category: "special",
        description: "A rapid flurry of jabs",
      },
      {
        name: "Jet Upper",
        input: "↓↙← + P",
      ...
      },
      {
        ...
        input: "↓↘→ + K",
        category: "special",
        description: "A ducking movement with follow-ups",
      },
      {
        name: "Rolling Thunder",
        input: "← + P (charge)",
        category: "special",
        description: "A forward rolling punch",
      },
      {
        name: "Rocket Upper",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 1,
        description: "SA1: A powerful spinning uppercut",
      },
      {
        name: "Rolling Thunder",
        input: "←→←→ + P",
        category: "super",
        superArt: 2,
        description: "SA2: Multiple rolling punches",
      },
      {
        name: "Corkscrew Blow",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 3,
        description: "SA3: A single devastating corkscrew punch",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "↓↘→ + K",
        category: "special",
        description: "A rising wheel kick",
      },
      {
        name: "Rhino Horn",
        input: "← + K (charge)",
        category: "special",
        description: "A sliding side kick",
      },
      {
        name: "Mallet Smash",
        input: "↓↙← + P",
        category: "special",
        description: "A powerful downward strike",
      },
      {
        name: "Spin Scythe",
        input: "↓↙← + K",
        category: "special",
        description: "A spinning low kick",
      },
      {
        name: "Brave Dance",
        input: "↓↘→↓↘→ + K",
        category: "super",
        superArt: 1,
        description: "SA1: A series of rapid kick combos",
      },
      {
        name: "Healing",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 2,
        description: "SA2: Recovers a portion of lost health",
      },
      {
        name: "Stungun Headbutt",
        input: "↓↙←↓↙← + K",
        category: "super",
        superArt: 3,
        description: "SA3: A powerful headbutt attack",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "→ + MP",
        category: "normal",
        description: "A spinning extended hook punch",
      },
      {
        name: "Electric Snake",
        input: "↓↘→ + P",
        category: "special",
        description: "An electric charge attack",
      },
      {
        name: "Slam Down",
        input: "↙↓↘ + P",
        category: "special",
        description: "An overhead slam attack",
      },
      {
        name: "Rising Cobra",
        input: "→↓↘ + K",
        category: "special",
        description: "A rising kick",
      },
      {
        name: "Spinning Beat",
        input: "←→ + K",
        category: "special",
        description: "A spinning extended kick",
      },
      {
        name: "Magnetic Storm",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 1,
        description: "SA1: Multiple electric strikes",
      },
      {
        name: "Hyper Tornado",
        input: "↓↘→↓↘→ + K",
        category: "super",
        superArt: 2,
        description: "SA2: A powerful tornado spin attack",
      },
      {
        name: "Cyber Lariat",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 3,
        description: "SA3: A single powerful electric lariat",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "↓ + HP",
        category: "normal",
        description: "A downward hammer strike",
      },
      {
        name: "Jinchu Watari",
        input: "→↓↘ + P",
        category: "special",
        description: "A hopping uppercut",
      },
      {
        name: "Nichirin Shou",
        input: "↓↘→ + P",
        category: "special",
        description: "A sun-energy fireball",
      },
      {
        name: "Hitobashira Nobori",
        input: "↓↙← + K",
        category: "special",
        description: "A wall-clinging kick",
      },
      {
        name: "Tsuranekeashi",
        input: "↓↙← + P",
        category: "special",
        description: "A multi-hit kick string",
      },
      {
        name: "Yagyou Dama",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 1,
        description: "SA1: An orb that bounces around the screen",
      },
      {
        name: "Kishin Tsui",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 2,
        description: "SA2: A powerful slam sequence",
      },
      {
        name: "Tengu Stone",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 3,
        description: "SA3: Summons stones that orbit and can be thrown",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "→ + HP",
        category: "normal",
        description: "A powerful chop to the neck",
      },
      {
        name: "Meat Squasher",
        input: "360° + P",
        category: "special",
        description: "A command grab that squeezes the opponent",
      },
      {
        name: "Monster Lariat",
        input: "← + P (charge)",
        category: "special",
        description: "A powerful spinning lariat",
      },
      {
        name: "Giant Palm Breaker",
        input: "↓↘→ + P",
        category: "special",
        description: "A rushing palm strike",
      },
      {
        name: "Shootdown Backbreaker",
        input: "↓↙← + P (air)",
        category: "special",
        description: "An anti-air grab from the air",
      },
      {
        name: "Gigas Breaker",
        input: "720° + P",
        ...
        superArt: 1,
        description:
          "SA1: A devastating power bomb requiring two full rotations",
      },
      {
        name: "Megaton Press",
        input: "↓↙←↓↙← + K",
        category: "super",
        superArt: 2,
        description: "SA2: A crushing body splash",
      },
      {
        ...
        category: "super",
        superArt: 3,
        description: "SA3: A series of powerful rushing slams",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "→ + HP",
        category: "normal",
        description: "A forward slashing attack",
      },
      {
        name: "Tourou Zan",
        input: "↓↘→ + P",
        category: "special",
        description: "A multi-hit slashing strike",
      },
      {
        name: "Zenpou Tenshin",
        input: "↓↙← + P",
        category: "special",
        description: "A teleport behind the opponent",
      },
      {
        name: "Kaihou",
        input: "↓↘→ + K",
        category: "special",
        description: "A rapid flip kick",
      },
      {
        name: "Senkyuutai",
        input: "↓↙← + K",
        category: "special",
        description: "A spinning heel kick",
      },
      {
        name: "Raishin Mahhaken",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 1,
        description: "SA1: A lightning-fast slashing combo",
      },
      {
        name: "Seiei-enbu",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 2,
        description: "SA2: Creates afterimage copies that mirror attacks",
      },
      {
        name: "Tenshin Senkyuutai",
        input: "↓↙←↓↙← + K",
        category: "super",
        superArt: 3,
        description: "SA3: A single powerful teleport kick",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "→ + MP",
        category: "normal",
        description: "A lunging shoulder attack",
      },
      {
        name: "Lunge Punch",
        input: "↓↘→ + P",
        category: "special",
        description: "A dashing punch",
      },
      {
        name: "Zenpou Tenshin",
        input: "↓↙← + P",
      ...
      },
      {
        ...
        input: "↓↘→ + K",
        category: "special",
        description: "A multi-hit overhead kick",
      },
      {
        name: "Tourou Zan",
        input: "↓↙← + K",
      ...
      },
      {
        ...
        category: "super",
        superArt: 1,
        description: "SA1: A single hit but massive damage palm strike",
      },
      {
        name: "Genei-jin",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 2,
        description: "SA2: Activates ghost mode for enhanced attacks",
      },
      {
        name: "Sourai Rengeki",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 3,
        description: "SA3: A rapid series of punches",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "↓ + HP",
        category: "normal",
        description: "An overhead palm strike",
      },
      {
        name: "Kunai",
        input: "↓↙← + P (air)",
        category: "special",
        description: "Throws a kunai from the air",
      },
      {
        name: "Kazekiri",
        input: "→↓↘ + P",
        category: "special",
        description: "A rising slashing kick",
      },
      {
        name: "Tsumuji",
        input: "↓↙← + K",
      ...
      },
      {
        ...
        input: "↓↘→ + K",
        category: "special",
        description: "A leaping neck kick",
      },
      {
        name: "Kasumi Suzaku",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 1,
        description: "SA1: Throws a screen-filling cloud of shurikens",
      },
      {
        name: "Hashinsho",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 2,
        description: "SA2: A rapid series of striking attacks",
      },
      {
        name: "Yoroi Dooshi",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 3,
        description: "SA3: A single piercing grab that deals massive damage",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "↓ + HP (up)",
        category: "normal",
        description: "An upward uppercut",
      },
      {
        name: "Karakusa",
        input: "↙ + P",
        category: "special",
        description: "A command grab that sets up combos",
      },
      {
        name: "Hayate",
        input: "↓↘→ + P",
        category: "special",
        description: "A charging punch that can be charged for power",
      },
      {
        name: "Oroshi",
        input: "↓ + HP (down)",
        category: "special",
        description: "A downward chop",
      },
      {
        name: "Tsurugi",
        input: "↓ + MK (air)",
        category: "special",
        description: "A dive kick",
      },
      {
        name: "Seichuusen Godanzuki",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 1,
        description: "SA1: A focused series of powerful punches",
      },
      {
        name: "Abare Tosanami",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 2,
        description: "SA2: A spinning slam attack",
      },
      {
        name: "Tanden Renki",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 3,
        description: "SA3: Temporary power boost that enhances all attacks",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        name: "Dashing Head Attack",
        input: "→ + HP",
        category: "normal",
        description: "A lunging headbutt",
      },
      {
        name: "Dashing Leg Attack",
        input: "→ + HK",
        category: "normal",
        description: "A lunging kick",
      },
      {
        name: "Dashing Head Attack",
        input: "← + P (charge)",
      ...
      },
      {
        ...
        input: "← + K (charge)",
        category: "special",
        description: "A charging kick",
      },
      {
        name: "High Speed Dash",
        input: "← + HP (charge)",
        category: "special",
        description: "A high-speed dash attack",
      },
      {
        name: "Capture & Deadly Blow",
        input: "360° + P",
        category: "special",
        description: "A command grab with a massive followup",
      },
      {
        ...
        category: "super",
        superArt: 1,
        description: "SA1: A devastating rushing attack",
      },
      {
        ...
        category: "super",
        superArt: 2,
        description: "SA2: Creates a defensive electromagnetic barrier",
      },
      {
        name: "Magnetic Storm",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 3,
        description: "SA3: A powerful single magnetic blast",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "↓↘→ + P",
        category: "special",
        description: "An arm transformed into an axe blade",
      },
      {
        name: "D.R.A.",
        input: "↓↙← + K",
        category: "special",
        description: "A morphing arm sweep",
      },
      {
        name: "N.D.L.",
        input: "↓↘→ + K",
        category: "special",
        description: "A needlepoint projectile",
      },
      {
        name: "A.C.I.D.",
        input: "↓↙← + P",
        category: "special",
        description: "A corrosive projectile",
      },
      {
        name: "X.C.O.P.Y.",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 1,
        description: "SA1: Transforms into a copy of the opponent",
      },
      {
        name: "A.X.E. 2nd",
        input: "↓↘→↓↘→ + K",
        category: "super",
        superArt: 2,
        description: "SA2: Multiple rapid axe strikes",
      },
      {
        ...
        category: "super",
        superArt: 3,
        description: "SA3: A single massive morphed strike",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "← + HP (charge)",
        category: "special",
        description: "A rushing tackle",
      },
      {
        name: "Metallic Sphere",
        input: "↓↘→ + P",
        category: "special",
        description: "A charged metallic ball projectile",
      },
      {
        name: "Dangerous Headbutt",
        input: "↓↑ + P (charge)",
        category: "special",
        description: "A powerful headbutt",
      },
      {
        name: "Temporal Thunder",
        input: "↓↙← + P",
        category: "special",
        description: "A lightning strike from the sky",
      },
      {
        name: "Violence Knee Drop",
        input: "↓↙← + K (air)",
        category: "special",
        description: "A diving knee drop",
      },
      {
        ...
        superArt: 1,
        description:
          "SA1: Deploys a reflecting forcefield that bounces back projectiles and traps opponents",
      },
      {
        ...
        category: "super",
        superArt: 2,
        description: "SA2: Multiple lightning strikes",
      },
      {
        name: "Poseidon Wave",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 3,
        description: "SA3: A powerful wave attack",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      },
      {
        ...
        input: "↓↙← + P",
        category: "special",
        description: "An ice projectile",
      },
      {
        name: "Moonsault Knee Drop",
        input: "↓↙← + K",
        category: "special",
        description: "A diving knee attack",
      },
      {
        name: "Seraphic Wing",
        input: "← + P (charge)",
        category: "special",
        description: "A wing-based energy attack",
      },
      {
        name: "Meteor Strike",
        input: "↓↘→↓↘→ + K",
        category: "super",
        superArt: 1,
        description: "SA1: A crashing energy strike from above",
      },
      {
        name: "Resurrection",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 2,
        description: "SA2: Gill revives himself upon KO with full health",
      },
      {
        name: "Seraphic Wing",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 3,
        description: "SA3: A devastating fire and ice energy blast",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "→ + MK",
        category: "normal",
        description: "A shoulder tackle",
      },
      {
        name: "Hadoken",
        input: "↓↘→ + P",
        category: "special",
        description: "A weak hadoken that bounces along the floor",
      },
      {
        name: "Shoryuken",
        input: "→↓↘ + P",
        category: "special",
        description: "An imitation dragon punch",
      },
      {
        name: "Tatsumaki Senpukyaku",
        input: "↓↙← + K",
        category: "special",
        description: "A slower hurricane kick version",
      },
      {
        name: "Sean Tackle",
        input: "↓↙← + K",
        category: "special",
        description: "A sliding tackle",
      },
      {
        name: "Basketball",
        input: "↓↙← + P",
        category: "special",
        description: "Bounces a basketball off the opponent",
      },
      {
        name: "Hadou Burst",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 1,
        description: "SA1: A massive but slow hadoken",
      },
      {
        name: "Sean Dynamite",
        input: "↓↙←↓↙← + P",
        category: "super",
        superArt: 2,
        description: "SA2: A rushing series of power strikes",
      },
      {
        name: "Shoryu Cannon",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 3,
        description: "SA3: An imitation Shoryuken super",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "↓ + MK",
        category: "normal",
        description: "A sweeping low kick",
      },
      {
        name: "Light of Justice (High)",
        input: "← + P (charge)",
        category: "special",
        description: "A high energy projectile",
      },
      {
        name: "Light of Justice (Low)",
        input: "← + K (charge)",
        category: "special",
        description: "A low energy projectile",
      },
      {
        name: "Rising Rage Flash",
        input: "↓↑ + K (charge)",
        category: "special",
        description: "A rising energy kick",
      },
      {
        name: "Cold Blue Kick",
        input: "↓↑ + K (charge, air)",
        category: "special",
        description: "A diving overhead kick",
      },
      {
        ...
        category: "super",
        superArt: 1,
        description: "SA1: A devastating multi-hit rising kick",
      },
      {
        name: "Souless Shore",
        input: "←→←→ + P",
        category: "super",
        superArt: 2,
        description: "SA2: Multiple energy projectiles",
      },
      {
        name: "The Final Resentment",
        input: "←→←→ + P",
        category: "super",
        superArt: 3,
        description: "SA3: A single powerful energy discharge",
      },
    ],
  },
  {
    ...
    moves: [
      ...
      { name: "Roundhouse", input: "HK", category: "normal" },
      {
        ...
        input: "↓↘→ + P",
        category: "special",
        description: "A dark hadoken",
      },
      {
        name: "Gou Shoryuken",
        input: "→↓↘ + P",
        category: "special",
        description: "A demon uppercut",
      },
      {
        name: "Tatsumaki Zankukyaku",
        input: "↓↙← + K",
        category: "special",
        description: "An air-traveling hurricane kick",
      },
      {
        name: "Shakunetsu Hadoken",
        input: "↓↙← + P",
        category: "special",
        description: "A flaming hadoken",
      },
      {
        name: "Hyakkishu",
        input: "↓↘→ + K",
        category: "special",
        description: "A demonic flip with follow-ups",
      },
      {
        name: "Teleport",
        input: "↓↘→ + PPP / KKK",
        category: "special",
        description: "Teleports across the screen",
      },
      {
        ...
        category: "super",
        superArt: 1,
        description: "SA1: Multiple dark hadokens",
      },
      {
        ...
        category: "super",
        superArt: 2,
        description: "SA2: Multiple rising demon uppercuts",
      },
      {
        name: "Shin Shoryuken",
        input: "↓↘→↓↘→ + P",
        category: "super",
        superArt: 3,
        description: "SA3: A single catastrophically powerful rising punch",
      },
    ],
  },
];
